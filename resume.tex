...
{Remote}
{
	...
	{June 2023 -- Present}
	{
		\begin{itemize}[nolistsep]
			...
			\item Designed scalable models for MySQL database using knex for data populating 5M\texttt{+} rows
			\item Diagnosed performance issues with SQL queries, such as race conditions, timeouts, connection pools
			\item Wrote several documentation articles outlining critical flows to business logic and debugging common FAQ's
		\end{itemize}
	}

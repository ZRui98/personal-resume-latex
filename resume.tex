...
\begin{tabular}{r|l}
	...
	\SplitEntry{Tools}{aws, git, docker, Spinnaker, Terraform, maven, kubernetes, prometheus, Datadog, nix, redis}
...
{Remote}
{
	...
	{Feb 2024 -- Present}
	{
		\begin{itemize}[nolistsep]
			...
			\item Added developer flow for dev builds, which sped up development speed by 300\%
			...
			\item Improved visibility of deploying and pinned versions in GraphQL backend and React UI
			\item Designed deployment flow for kubernetes migrations from EC2, which was critical to migrating 50\texttt{+} services to onboard onto kubernetes

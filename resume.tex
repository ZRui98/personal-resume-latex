...
{Remote}
{
	...
	{Feb 2024 -- Present}
	{
		\begin{itemize}[nolistsep]
			...
			\item Designed and built features in Spinnaker (Kubernetes deploys, Buildkite CI, and timed rollbacks), increasing adoption by 15\texttt{+}\%
			\item Reduced cpu/memory resource usage by 30\% by optimizing internal logic for Spinnaker constraint evaluations
			\item Improved MySQL performance by up to 20\% through query analysis and index optimization
			...
			\item Collaborated with observability team to design better canary analysis verification, improving safety of deployments by 50\%
		\end{itemize}
	}
}
...
{\begin{itemize}
	...
	\item Deployed to Cloudflare R2 \texttt{+} Pages \texttt{+} and kubernetes, using fluxCD/github actions
\end{itemize}}
\ProjectEntry{fserv}
{Golang, Postgres}

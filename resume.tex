...
{Remote}
{
	...
	{Feb 2024 -- Present}
	{
		\begin{itemize}[nolistsep]
			\item Contributed to Pinterest's VM/EC2 management system teletraan written in Java
			\item Developed new features for Pinterest's CD system based on Spinnaker for both EC2 and Kubernetes
		\end{itemize}
	}
}

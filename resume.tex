...
{Remote}
{
	...
	{June 2023 -- Present}
	{
		\begin{itemize}[nolistsep]
			...
			\item Built new invoicing Lambda for custom invoicing to Chargebee as part of integration work
			...
			\item Diagnosed performance issues with MySQL db instances, such as race conditions, timeouts, connection pools

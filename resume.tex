...
\begin{tabular}{r|l}
	...
	\SplitEntry{Tools}{aws, git, kubernetes, prometheus, docker, maven, nix, redis}
...
{Remote}
{
	...
	{Feb 2024 -- Present}
	{
		\begin{itemize}[nolistsep]
			\item Contributed to Pinterest's VM management system teletraan written in Java
			\item Developed Pinterest's CD system for both EC2 and Kubernetes (custom plugins based Spinnaker) serving 60K+ compute resources
			\item Implemented user friendly UX experience in Spinnaker's Deck UI (React)
			\item Optimized artifact deployment flow, improving performance by 70\%
		\end{itemize}
	}
}
...
{\begin{itemize}
	...
	\item Deployed to Cloudflare R2 \texttt{+} Pages \texttt{+} and kubernetes
	\item Full CI/CD stack using fluxCD/github actions with monitoring (victoriametrics)
\end{itemize}}
\ProjectEntry{fserv}
{Golang, Postgres}

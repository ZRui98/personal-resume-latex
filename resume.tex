...
{\begin{itemize}
	...
	\item Designed editor using svelte-jsoneditor and custom logic to simplify
	\item Implemented storing audio and image files to show during adventure
	\item Social auth login with stateless sessions
	\item Deployed using Github Actions on Cloudflare R2 \texttt{+} Pages \texttt{+} PM2
\end{itemize}}
\ProjectEntry{fserv}
{Golang, Postgres}

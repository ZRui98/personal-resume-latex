...
{\begin{itemize}[nolistsep]
	\item Implemented new content and figma designs in Gatsby React site servicing 15000\texttt{+} unique visitors/week
	\item Participated in the design and development of lambda NodeJS REST API's for CRUD operations on business logic
	...
	\item Implemented new internal dev environment using golang lambda as file server to serve content from s3

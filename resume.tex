...
{Remote}
{
	...
	{June 2023 -- Present}
	{
		\begin{itemize}[nolistsep]
			\item Designed and shipped new user-facing billing feature providing auto billing for 50K\texttt{+} items that were manually billed
			\item Helped Build new invoicing flow for billable items interacting with Chargebee as part of integration
	...
	\DatedEntry{Software Engineer Intern}
		{May 2020 -- Aug 2020}
		{
			\begin{itemize}[nolistsep]
				...
				\item Created new endpoints and business logic in RESTful NodeJS APIs that were consumed nt end
